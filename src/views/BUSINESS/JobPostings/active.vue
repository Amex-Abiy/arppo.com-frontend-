<template>
    <div>
        ...
        <div v-show="!errorMsg" v-for="posting in jobPostingsList" v-bind:key="posting.id" class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row card-content-rows">
                            ...
                            <p class="discription">{{ posting.jobReq }}</p>
                        </div>
                        <div class="row card-content-rows">
...
export default {
    ...
    methods: {
        getActiveJobPostings() {
            axios.get('/business/manage/jobPostings/getOnGoing').then((result) => {
                if(result.data.status) {
                    this.jobPostingsList = result.data.data;
                    this.errorMsg = null;
                } else {
